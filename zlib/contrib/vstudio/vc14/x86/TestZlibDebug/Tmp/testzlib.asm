; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30145.0 
	...
	TITLE	D:\Dev\Exodus\Third\zlib\zlib\contrib\vstudio\vc14\x86\TestZlibDebug\Tmp\testzlib.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG99597 DB	'rb', 00H
	ORG $+5
$SG99658 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG99661 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG99662 DB	'file %s read, %u bytes', 0aH, 00H
$SG99666 DB	'1.2.11', 00H
	ORG $+1
$SG99667 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG99668 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG99669 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG99670 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG99671 DB	'1.2.11', 00H
	ORG $+1
$SG99672 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG99673 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG99674 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG99675 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG99678 DB	'compare ok', 0aH, 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File D:\Dev\Exodus\Third\zlib\zlib\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File C:\Program Files (x86)\Windows Kits\10\Include\10.0.20348.0\um\winnt.h
...
; 1024 :     __asm    {
; 1025 :         mov     ecx, ShiftCount

	mov	ecx, DWORD PTR _ShiftCount$[ebp]

; 1026 :         mov     eax, dword ptr [Value]

	mov	eax, DWORD PTR _Value$[ebp]

; 1027 :         mov     edx, dword ptr [Value+4]

	mov	edx, DWORD PTR _Value$[ebp+4]

; 1028 :         shrd    eax, edx, cl
